...
2. `AGENTS.md` routes the task to the tracked development skills in `agents/skills/`.
3. `agents/skills/manifest.yaml` declares each skill's scope, priority, and source.
4. These workflow notes supply repeatable procedures for audit, docs, and
   release work.

The tracked `agents/skills/` directory is for developing this plugin. It is separate
